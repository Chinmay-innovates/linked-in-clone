...
/**
 * Retrieves a list of posts from the users that the current user is connected to.
 *
...
export const createComment = async (req, res) => {
	try {
		...
		//  create the notfication if the comment owner is not the post owner
...
export const likePost = async (req, res) => {
	try {
		...
		if (post.likes.includes(userId)) {
			...
			// create the notfication if the like owner is not the post owner
			if (post.author.toString() !== userId.toString()) {
				const newNotification = new Notification({
					recipient: post.author,
					type: "like",
